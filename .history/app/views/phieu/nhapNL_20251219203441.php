...
<div class="content-wrapper">
    ...
    <div class="card">
        <form method="post" action="/PTUD_QLSX_NHAMAY_NOPAINNOGAIN/index.php?controller=phieunhapNL&action=nhapPhieu">
                    ...
                    if (!empty($ds_nguyenlieu)) {
                        foreach ($ds_nguyenlieu as $nl) {
                            ...
                            echo '<option value="'.htmlspecialchars($nl['manguyenlieu']).'" '
                                 ...
                                 .'data-makehoach="'.htmlspecialchars($nl['makehoach']).'">'
            ...
            <div class="form-group">
                <label><strong>Mã kế hoạch</strong></label>
                <input type="text" id="maKeHoach" name="maKeHoach" class="form-control" readonly required>
            </div>
            <div class="form-group">
...
function capNhatThongTin() {
    ...
    document.getElementById('maKeHoach').value = opt.getAttribute('data-makehoach') || '';
}
</script>
</body>
</html>
